 ...
 * 
 * Admin page to edit existing membership/subscription plans.
 * 
...
<body>
    ...
    <section class="bg-cyan-700 text-white text-center py-10">
        <h1 class="text-3xl font-bold">Edit Membership Plan</h1>
        <p class="opacity-90">Modify the membership subscription plan</p>
    </section>
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="<?= htmlspecialchars($_POST['name'] ?? $membership['name'] ?? '') ?>"
                            required
                        >
                    </div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="3"
                        ><?= htmlspecialchars($_POST['description'] ?? $membership['description'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                step="0.01"
                                min="0"
                                value="<?= htmlspecialchars($_POST['price'] ?? $membership['price'] ?? '') ?>"
                                required
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="30"
                                min="1"
                                value="<?= htmlspecialchars($_POST['duration_days'] ?? $membership['duration_days'] ?? '30') ?>"
                                required
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="4"
                                min="1"
                                value="<?= htmlspecialchars($_POST['bottles_per_week'] ?? $membership['bottles_per_week'] ?? '4') ?>"
                                required
                            >
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        ...
                        <p class="text-gray-600 text-sm">
                            ...
                            <span id="bottles-summary"><?= htmlspecialchars($membership['bottles_per_week'] ?? '4') ?></span> bottles per week for 
                            <span id="days-summary"><?= htmlspecialchars($membership['duration_days'] ?? '30') ?></span> days at Rs <span id="price-summary"><?= htmlspecialchars(number_format($membership['price'] ?? 0, 2)) ?></span>.
                        </p>
                        <p class="text-gray-600 text-sm mt-2">
                            Total bottles: <span class="font-bold" id="total-bottles"><?= ceil(($membership['duration_days'] ?? 30) / 7) * ($membership['bottles_per_week'] ?? 4) ?></span>
                        </p>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        >
                            <i class="fas fa-save mr-2"></i>Update Membership Plan
                        </button>
                        <a 
